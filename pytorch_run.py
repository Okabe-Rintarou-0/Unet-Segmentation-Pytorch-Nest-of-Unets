...
t_data = './dataset_for_test/train/image/'
l_data = './dataset_for_test/train/label/'
test_image = './dataset_for_test/train/image/00001.png'
test_label = './dataset_for_test/train/image/00001.png'
test_folderP = './folderP/'
test_folderL = './folderL/'

# Read images and labels, do some pre-treatment
...
if os.path.exists(read_model_path) and os.path.isdir(read_model_path):
    ...
    model_path = read_model_path + '/Unet_epoch_' + str(epoch) + '_batchsize_' + str(batch_size) + '.pth'
    model_test.load_state_dict(torch.load(model_path))
    print('Model folder there, so load from existing model')
...
<<<<<<< HEAD
    for x, y in train_loader:
        ...
        input_images(x, y, i, n_iter, new_id, k)
...
>>>>>>> 44dda492b4b9f11423cf8278f51c673acf8b219e
    ...
    x1 = plt.imsave(
        './model/pred/' + str(new_id) + '/img_iteration_' + str(n_iter) + '_epoch_'
    ...
    plot_kernels(new_id, dr.features, n_iter, 7, cmap="rainbow")
